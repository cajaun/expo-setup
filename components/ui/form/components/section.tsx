    ...
    >
      {title || titleHint ? (
        <View style={styles.titleRow}>
          {title ? <SectionLabel fonts={fonts}>{title}</SectionLabel> : null}
          {titleHint ? (
            <SectionHint fonts={fonts}>{titleHint}</SectionHint>
          ) : null}
        </View>
      ) : null}
      ...
      {footer ? <SectionFooter fonts={fonts}>{footer}</SectionFooter> : null}
    </View>
  );
}
...
function SectionLabel({
  ...
  return (
    <RNText style={[styles.sectionLabel, { fontFamily: fonts.regular }]}>
      {children}
    </RNText>
  );
}
...
function SectionHint({
  ...
  return (
    <RNText style={[styles.sectionHint, { fontFamily: fonts.regular }]}>
      {children}
    </RNText>
  );
}
...
function SectionFooter({
  ...
  return (
    <RNText style={[styles.sectionFooter, { fontFamily: fonts.regular }]}>
      {children}
    </RNText>
  );
}
