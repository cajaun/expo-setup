...
import type { ToastRootProps, ToastVariant } from './view';

export type ToastTextSize =
  | 'largeTitle'
  | 'title'
  | 'title2'
  | 'title3'
...
export interface ToastSlotOptions {
...
export interface ToastOptions {
  /**
   * Optional color scheme override for apps that do not use this project's theme hook.
   */
  colorScheme?: ToastColorScheme;
  /**
   * Class names applied to default toast slots.
   */
  classNames?: ToastClassNames;
  /**
   * React Native styles applied to default toast slots.
   */
  styles?: ToastStyles;
  /**
   * Variant-specific slot overrides. These are applied after global slot options.
   */
  variants?: Partial<Record<ToastVariant, ToastSlotOptions>>;
}
...
export interface ToastProviderProps {
  ...
  /**
   * App-level styling and theme overrides for the built-in toast UI.
   */
  toastOptions?: ToastOptions;
  /**
...
export interface ToastShowConfig
  ...
  /**
   * Size for string/SF Symbol toast icons.
   * @default 20
   */
  iconSize?: number;
  /**
   * Shared typography size for the label and description.
   */
  textSize?: ToastTextSize;
  /**
   * Typography size for the label.
   */
  labelTextSize?: ToastTextSize;
  /**
   * Typography size for the description.
   */
  descriptionTextSize?: ToastTextSize;
  /**
...
export interface ToastHostContextValue {
  toast: ToastManager;
  /**
