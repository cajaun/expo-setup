...
import type * as ToastPrimitive from '../base/accessible-toast.types';
import type {
  ToastComponentProps,
  ToastShowOptions,
  ToastTextSize,
...
export interface ToastTitleProps extends ToastPrimitive.TitleProps {
  ...
  className?: string;
  /**
   * App typography size for the title.
   */
...
export interface ToastDescriptionProps extends ToastPrimitive.DescriptionProps {
  ...
  className?: string;
  /**
   * App typography size for the description.
   */
  textSize?: ToastTextSize;
}
...
export interface DefaultToastProps extends ToastComponentProps {
  /**
   * Additional style for the toast root.
   */
  style?: ToastRootProps['style'];
  /**
   * Visual variant of the toast
   * @default 'default'
   */
  ...
  iconSize?: number;
  /**
   * Shared typography size for label and description.
   */
  textSize?: ToastTextSize;
  /**
   ...
   */
  labelStyle?: ToastTitleProps['style'];
  /**
   * Additional style for the description text.
   */
  descriptionStyle?: ToastDescriptionProps['style'];
}
